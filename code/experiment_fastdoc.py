...
# For formatting the text using tex
...
time3 = np.empty([number_tries, len(p_array)])
...
plt.errorbar(p_array, av_time3, yerr=yerr_time3, elinewidth=1, capsize=2, label="Average time waited by (cured) type 3 patients")
plt.legend()
