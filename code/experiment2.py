...
test(sarsa,
    ...
    epsilon = 0.1,
    plot_type = "hist",
    title1 = "Sarsa + 1-hot feature + early rewards",
...
test(sarsa,
    ...
    epsilon = 0.1,
    plot_type = "hist",
    title1 = "Sarsa + 1-hot feature + late rewards",
    title2 = "Reward evolution for the picture above",
    earlyRewards = False)
...
test(ql,
    ...
    epsilon = 0.1,
    plot_type = "hist",
    title1 = "Q-learning + 1-hot feature + early rewards",
    title2 = "Reward evolution for the picture above",
    earlyRewards = True)
...
test(sarsa,
    ...
    epsilon = 0.1,
    plot_type = "hist",
    title1 = "sarsa + feature_1 + early rewards",
    title2 = "Reward evolution for the picture above",
    earlyRewards = True)
...
test(sarsa,
    ...
    epsilon = 0.1,
    plot_type = "hist",
    title1 = "sarsa + 1-hot + early rewards + cap pen",
    title2 = "Reward evolution for the picture above",
    earlyRewards = True,
